    ...
    return (
        <div style={{ background: '#141414', minHeight: '100vh', padding: '30px 20px', color: '#fff' }}>
            ...
            <style>{`
                ...
                .custom-dark-select .ant-select-selector { background-color: #141414 !important; border: 1px solid #303030 !important; color: #fff !important; border-radius: 8px !important; height: 40px !important; align-items: center; }
                .custom-dark-select:hover .ant-select-selector { border-color: #1890ff !important; }
                .custom-dark-select .ant-select-arrow { color: #a6a6a6 !important; }
                .custom-dark-dropdown { background-color: #1f1f1f !important; border: 1px solid #303030 !important; border-radius: 8px !important; }
                .custom-dark-dropdown .ant-select-item { color: #a6a6a6 !important; }
                .custom-dark-dropdown .ant-select-item-option-active, .custom-dark-dropdown .ant-select-item:hover { background-color: rgba(24, 144, 255, 0.1) !important; color: #1890ff !important; }
                
                .position-card { background: #1f1f1f !important; border: 1px solid #303030 !important; border-radius: 12px !important; margin-bottom: 24px; transition: all 0.3s; }
                .position-card:hover { border-color: #fa8c16 !important; box-shadow: 0 4px 15px rgba(250, 140, 22, 0.15); }
                
                /* Class tùy chỉnh Nút ứng tuyển đẹp mắt */
                .btn-apply-now {
                ...
                .btn-apply-now:hover {
                    ...
                    box-shadow: 0 6px 16px rgba(250, 140, 22, 0.5) !important;
