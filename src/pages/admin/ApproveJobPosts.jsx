...
const ApproveCampaigns = () => {
    ...
    // 2. Duyệt TẤT CẢ vị trí trong chiến dịch (Nút bên trong Drawer)
    ...
    // Bảng bên ngoài: Chỉ có 1 nút "Xem & Thẩm định" duy nhất
    const columns = [
        {
                        ...
                        <List
                            ...
                            renderItem={(viTri, index) => (
                                ...
                                >
                                    ...
                                    {/* Chỉ hiển thị nút khi vị trí đang chờ duyệt (trangThai === 0) */}
                                    {viTri.trangThai === 0 && (
